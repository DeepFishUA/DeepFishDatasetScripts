...
all_images = os.listdir(sys.argv[1])


# Moverlo todo a output_COCO
os.system("rm -f -R output_COCO")
os.system("mkdir output_COCO")
os.system("mv images " + "output_COCO/images")


transcribeData("output_COCO")
